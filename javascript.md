...
40. Check if a string is a **Palindrome**. Also do it **without any string, array methods**. Hint: Use any loop here.
...
49. Check if a string is a rotation of another string.
50. Check if a string is a valid shuffle of two other strings.
51. Find the longest common prefix among an array of strings.
52. Convert a sentence into an acronym (e.g., "Portable Network Graphics" → "PNG").
53. Replace spaces in a string with `%20` (URL Encoding).

### Array & Object Logic
56. Write a program to **remove duplicates** from an array. Advance version: Don't use **new array, don't use Set()**. Hint: Use any **loop** and implement using **.splice()** method 
...
62. Flatten a **nested array** into a single-dimensional array (Deep Flatten). Work on different solutions for the same problem.
